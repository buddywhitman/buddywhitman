...
| [**sgl-project/sglang**](https://github.com/sgl-project/sglang/pull/27498) | [#27498](https://github.com/sgl-project/sglang/pull/27498) | **P-EAGLE**: parallel speculative decoding for SGLang — generates all K draft tokens in a single forward pass instead of K sequential passes, porting the technique from vLLM v0.16.0 and closing [#23171](https://github.com/sgl-project/sglang/issues/23171). +37K lines, 14 review comments |
