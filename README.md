...
| [**sgl-project/sglang**](https://github.com/sgl-project/sglang/pull/30982) | [#30982](https://github.com/sgl-project/sglang/pull/30982) | DSpark speculative decoding (SGLang): root-caused a checkpoint-format compatibility bug causing ~3.6x accept-length degradation (1.1→3.97 tokens/step) on speculators-format checkpoints in an actively-developed spec-decode feature backed by an official lmsys.org release. |
